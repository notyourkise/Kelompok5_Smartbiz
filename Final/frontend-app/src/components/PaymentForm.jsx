...
import {
  ...
  Table,
  Alert,
} from "react-bootstrap"; // Added Alert
    ...
    try {
      ...
      if (response.status === 201 || response.status === 200) {
        ...
        const errorData = response.data || {
          message: `Gagal mencatat transaksi. Status: ${response.status}`,
        };
        setPaymentError(
          errorData.message || "Terjadi kesalahan saat mencatat transaksi."
        );
      }
    } catch (error) {
      ...
      if (
        ...
        setPaymentError(
          "Gagal terhubung ke server atau terjadi kesalahan tidak dikenal."
        );
      }
    } finally {
      setIsProcessing(false);
    ...
    <div className="payment-form-elegant-container">
      <Container fluid="lg" className="py-4">
        <Button
          ...
          className="back-link-button mb-3 ps-0"
        >
          ...
          <Card.Body className="p-4">
              ...
              <Col md={6} className="mb-4 mb-md-0 customer-payment-section">
                ...
                <Form>
                  <Form.Group
                    ...
                    className="mb-4 form-group-elegant"
                  >
                  ...
                  <Form.Group
                    ...
                    className="mb-3 form-group-elegant"
                  >
                    <Form.Label>
                ...
                <div className="order-summary-box p-3">
                  ...
                  {cart.length > 0 && (
                    <div className="total-section text-end mt-3 pt-3 border-top">
                      <h5 className="total-amount fw-bold">
            ...
            <div className="text-center mt-4 pt-4 border-top payment-actions">
              <Button
                ...
                onClick={handleBackToMenu}
                className="me-sm-3 mb-2 mb-sm-0 action-button-elegant back-button-elegant"
              >
